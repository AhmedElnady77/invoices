                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ url('FawateerDetails') }}/{{ $invoice->id }}">{{ $invoice->section->section_name }}</a>
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu tx-13">
                                            <a class="dropdown-item" href=" {{ url('edit_fawateer') }}/{{ $invoice->id }}">تعديل
                                                الفاتورة</a>
