                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>رقم الفاتورة</span>
                                    <span>{{ $fawateers->invoice_number }}</span></p>
                                <p class="invoice-info-row"><span>تاريخ الاصدار</span>
                                    <span>{{ $fawateers->invoice_Date }}</span></p>
                                <p class="invoice-info-row"><span>تاريخ الاستحقاق</span>
                                    <span>{{ $fawateers->Due_date }}</span></p>
                                <p class="invoice-info-row"><span>القسم</span>
                                    <span>{{ $fawateers->section->section_name }}</span></p>
                            </div>
                        </div>
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td class="tx-12">{{ $fawateers->product }}</td>
                                        <td class="tx-center">{{ number_format($fawateers->Amount_collection, 2) }}</td>
                                        <td class="tx-right">{{ number_format($fawateers->Amount_Commission, 2) }}</td>
                                        <?php
                                        $total = $fawateers->Amount_collection + $fawateers->Amount_Commission ;
                                        ?>                                        
                                        <td class="tx-right">
                                    ...
                                    <tr>
                                        <td class="tx-right">نسبة الضريبة ({{ $fawateers->Rate_VAT }})</td>
                                        <td class="tx-right" colspan="2">287.50</td>
                                    </tr>
                                    <tr>
                                        <td class="tx-right">قيمة الخصم</td>
                                        <td class="tx-right" colspan="2"> {{ number_format($fawateers->Discount, 2) }}</td>

                                    </tr>
                                    <tr>
                                        <td class="tx-right tx-uppercase tx-bold tx-inverse">الاجمالي شامل الضريبة</td>
                                        <td class="tx-right" colspan="2">
                                            <h4 class="tx-primary tx-bold">{{ number_format($fawateers->Total, 2) }}</h4>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
