			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/20.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{url('/' . $page='fawateer')}}">قائمة الفواتير</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='fawateer_paid') }}">الفواتير المدفوعة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='fawateer_unpaid') }}">الفواتير الغير مدفوعة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='fawateer_partial') }}">الفواتير المدفوعة جزئيا</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='fawateer_archive') }}">ارشيف الفواتير</a></li>
